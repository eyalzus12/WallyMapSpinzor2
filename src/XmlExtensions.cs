...
public static class XmlExtensions
{
    ...
    public static double GetFloatAttribute(this XElement element, string attribute, double @default = 0.0f) => double.Parse(element.GetAttribute(attribute, @default.ToString()), CultureInfo.InvariantCulture);
