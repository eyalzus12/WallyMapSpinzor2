...
public class TeamScoreboard : IDeserializable, ISerializable, IDrawable
{
        ...
        where T : ITexture
    {
        ...
        if (config.RedScore < 10)
        {
            ...
            canvas.DrawSwf(LevelDesc.GAMEMODE_BONES, fontName, 1, 0, 0, 1, redOnesTrans, DrawPriorityEnum.FOREGROUND, this);
        }
        else
        {
            ...
            canvas.DrawSwf(LevelDesc.GAMEMODE_BONES, fontNameOnes, 1, 0, 0, 1, redOnesTrans, DrawPriorityEnum.FOREGROUND, this);
            ...
            canvas.DrawSwf(LevelDesc.GAMEMODE_BONES, fontNameTens, 1, 0, 0, 1, redTensTrans, DrawPriorityEnum.FOREGROUND, this);
        }
        ...
        if (config.BlueScore < 10)
        {
            ...
            canvas.DrawSwf(LevelDesc.GAMEMODE_BONES, fontName, 1, 0, 0, 1, blueOnesTrans, DrawPriorityEnum.FOREGROUND, this);
        }
        else
        {
            ...
            canvas.DrawSwf(LevelDesc.GAMEMODE_BONES, fontNameOnes, 1, 0, 0, 1, blueOnesTrans, DrawPriorityEnum.FOREGROUND, this);
            ...
            canvas.DrawSwf(LevelDesc.GAMEMODE_BONES, fontNameTens, 1, 0, 0, 1, blueTensTrans, DrawPriorityEnum.FOREGROUND, this);
        }
    }
}